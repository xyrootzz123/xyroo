...
module.exports = xyroo = async (xyroo, m, msg, store) => {
	...
	try {
		...
		switch(fileSha256 || command) {
			...
			// Quotes Menu
			case 'motivasi': {
				const hasil = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/kata-kata/motivasi.json');
				m.reply(pickRandom(hasil))
			}
			break
			case 'bijak': {
				const hasil = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/kata-kata/bijak.json');
				m.reply(pickRandom(hasil))
			}
			break
			case 'dare': {
				const hasil = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/kata-kata/dare.json');
				m.reply(pickRandom(hasil))
			}
			break
			case 'quotes': {
				const res = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/kata-kata/quotes.json');
				const hasil = pickRandom(res);
				m.reply(`_${hasil.quotes}_\n\n*- ${hasil.author}*`)
			}
			break
			case 'truth': {
				const hasil = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/kata-kata/truth.json');
				m.reply(`_${pickRandom(hasil)}_`)
			}
			break
			case 'renungan': {
				const hasil = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/kata-kata/renungan.json');
				m.reply('', {
					contextInfo: {
						forwardingScore: 10,
						isForwarded: true,
			...
			break
			case 'bucin': {
				const hasil = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/kata-kata/bucin.json');
				m.reply(pickRandom(hasil))
			}
			break
			...
			case 'waifu': case 'neko': {
				try {
					...
					await xyroo.sendFileUrl(m.chat, res.url, 'Random Waifu', m)
					setLimit(m, db)
				} catch (e) {
					m.reply('Server sedang offline!')
				}
			...
			case 'cekkhodam': {
				if (!text) return m.reply(`Example : ${prefix + command} nama lu`)
				try {
					const res = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/random/cekkhodam.json');
					const hasil = pickRandom(res);
			...
			case 'tekateki': {
				...
				const soal = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/games/tekateki.json');
			...
			case 'tebaklirik': {
				...
				const soal = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/games/tebaklirik.json');
				const hasil = pickRandom(soal);
			...
			case 'tebakkata': {
				...
				const soal = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/games/tebakkata.json');
				const hasil = pickRandom(soal);
			...
			case 'family100': {
				...
				const soal = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/games/family100.json');
				const hasil = pickRandom(soal);
				let { key } = await m.reply(`🎮 Tebak Kata Berikut :\n\n${hasil.soal}\n\nWaktu : 5m\nHadiah *+3499*`)
				family100[m.chat] = {
					soal: hasil.soal,
			...
			case 'susunkata': {
				...
				const soal = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/games/susunkata.json');
				const hasil = pickRandom(soal);
			...
			case 'tebakkimia': {
				...
				const soal = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/games/tebakkimia.json');
				const hasil = pickRandom(soal);
			...
			case 'caklontong': {
				...
				const soal = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/games/caklontong.json');
				const hasil = pickRandom(soal);
			...
			case 'tebaknegara': {
				...
				const soal = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/games/tebaknegara.json');
				const hasil = pickRandom(soal);
			...
			case 'tebakgambar': {
				...
				const soal = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/games/tebakgambar.json');
				const hasil = pickRandom(soal);
			...
			case 'tebakbendera': {
				...
				const soal = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/games/tebakbendera.json');
				const hasil = pickRandom(soal);
			...
			case 'tebakangka': case 'butawarna': case 'colorblind': {
				...
				const soal = await fetchJson('https://raw.githubusercontent.com/xyroodev/database/refs/heads/master/random/color_blind.json');
				const hasil = pickRandom(soal);
			...
			case 'menu': {
				...
				} else await templateMenu(xyroo, set.template, m, prefix, setv, db, { botNumber, author, packname, isVip, isPremium })
			}
			break
			case 'allmenu': {
				let profile
				try {
					profile = await xyroo.profilePictureUrl(m.sender, 'image');
				} catch (e) {
					profile = fake.anonim
				}
				const menunya = `
